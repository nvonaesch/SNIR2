...
function geolocalisationv2(){
    ...
    if(adresse.length === 0){
        $("#zoneTexte").attr("placeholder","Cet endroit n'est pas trouvé");
        console.log("Endroit non trouvé");
        alert("Cet endroit est inconnu");
    }else{
...
$(document).ready(function () {
    ...
    $("#envoyerCoord").click(geolocalisationv2);
});
